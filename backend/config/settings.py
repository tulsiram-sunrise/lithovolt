"""
Django settings for Lithovolt project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='lithovolt_db'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@lithovolt.com.au')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Lithovolt Battery Management API',
    'DESCRIPTION': 'API documentation for Lithovolt Battery Management Platform',
    'VERSION': '1.0.0',
